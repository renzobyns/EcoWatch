export default function LoginLoading() {
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center p-4 sm:p-6 animate-pulse">
            <div className="w-full max-w-md bg-card/70 rounded-3xl border border-border/60 p-6 sm:p-8 space-y-6">
                <div className="text-center space-y-2">
                    <div className="w-12 h-12 rounded-2xl bg-primary/20 mx-auto" />
                    <div className="h-6 w-40 bg-muted/70 rounded-lg mx-auto" />
                    <div className="h-3.5 w-60 bg-muted/40 rounded mx-auto" />
                </div>
