                                ...
                                <tbody>
                                    {paginated.map(row => (
                                        ...
                                        >
                                            ...
                                            <td className="py-4 px-4">
                                                <div className="relative group/status flex items-center justify-center gap-1.5 cursor-help w-fit mx-auto">
    ...
    return (
        ...
        >
            ...
            <div className="flex items-start justify-between gap-2 relative z-20">
                ...
                <div className={`relative group/status flex items-center gap-1.5 shrink-0 px-2 py-1 rounded-md border text-xs font-medium cursor-help ${
